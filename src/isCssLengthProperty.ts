...
export const cssLengthProperties = Object.keys(cssLengthPropertiesLookup).sort();

export function isCssLengthProperty(property: keyof CSSProperties): property is keyof typeof cssLengthPropertiesLookup {
  return Boolean(cssLengthPropertiesLookup[ property ]);
}
